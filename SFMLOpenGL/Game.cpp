...
void Game::initialize()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(VertexOne) * 8, vertex, GL_STATIC_DRAW);
	...
	const char* fs_src = "#version 400\n\r"
		...
		"	fColor = texture(f_texture, texel.xy);"
		"}"; //Fragment Shader Src
...
void Game::render()
{
	...
	glVertexAttribPointer(positionID, 3, GL_FLOAT, GL_FALSE, sizeof(VertexOne), 0);
	glVertexAttribPointer(colorID, 4, GL_FLOAT, GL_FALSE, sizeof(VertexOne), 0);
	glVertexAttribPointer(texelID, 2, GL_FLOAT, GL_FALSE, sizeof(VertexOne), 0);
